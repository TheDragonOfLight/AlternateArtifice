...
public class EnchantmentTreasureFinder extends Enchantment {
    public EnchantmentTreasureFinder() {
        super(Rarity.VERY_RARE, EnumEnchantmentType.ALL, new EntityEquipmentSlot[] {EntityEquipmentSlot.MAINHAND});
        this.setName("treasurefinder");
        this.setRegistryName(new ResourceLocation(Reference.MODID + ":treasurefinder"));
