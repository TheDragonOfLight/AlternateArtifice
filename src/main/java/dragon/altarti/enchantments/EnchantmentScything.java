...
public class EnchantmentScything extends Enchantment {
    public EnchantmentScything() {
        super(Rarity.VERY_RARE, EnumEnchantmentType.ALL, new EntityEquipmentSlot[] {EntityEquipmentSlot.MAINHAND});
        this.setName("scything");
        this.setRegistryName(new ResourceLocation(Reference.MODID + ":scything"));
