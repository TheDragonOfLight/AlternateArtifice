...
public class EnchantmentComfortableFit extends Enchantment {
    public EnchantmentComfortableFit() {
        super(Rarity.VERY_RARE, EnumEnchantmentType.ARMOR_LEGS, new EntityEquipmentSlot[] {EntityEquipmentSlot.LEGS});
        this.setName("comfortablefit");
        this.setRegistryName(new ResourceLocation(Reference.MODID + ":comfortablefit"));
