...
public class EnchantmentApplePicker extends Enchantment {
    public EnchantmentApplePicker() {
        super(Rarity.VERY_RARE, EnumEnchantmentType.ALL, new EntityEquipmentSlot[] {EntityEquipmentSlot.MAINHAND});
        this.setName("applepicker");
        this.setRegistryName(new ResourceLocation(Reference.MODID + ":applepicker"));
