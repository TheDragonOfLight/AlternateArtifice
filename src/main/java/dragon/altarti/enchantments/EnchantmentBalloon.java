...
public class EnchantmentBalloon extends Enchantment {
    public EnchantmentBalloon() {
        super(Rarity.VERY_RARE, EnumEnchantmentType.ARMOR_HEAD, new EntityEquipmentSlot[] {EntityEquipmentSlot.HEAD});
        this.setName("balloon");
        this.setRegistryName(new ResourceLocation(Reference.MODID + ":balloon"));
